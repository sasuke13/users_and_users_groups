...
class GroupsSerializer(serializers.Serializer):
    ...
    data_analytics = serializers.BooleanField(required=False, default=False)
    service_analytics = serializers.BooleanField(required=False, default=False)
    voice_analytics = serializers.BooleanField(required=False, default=False)
    queue_stats = serializers.BooleanField(required=False, default=False)
    voice_stats = serializers.BooleanField(required=False, default=False)
    video = serializers.BooleanField(required=False, default=False)
    smart_access = serializers.BooleanField(required=False, default=False)
    diagrams = serializers.BooleanField(required=False, default=False)
